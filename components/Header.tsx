  ...
  return (
    <div className="sticky top-0 z-50 border-b bg-white shadow-sm">
      <div className="mx-5 flex max-w-6xl items-center justify-between bg-white lg:mx-auto">
        <div
          onClick={() => router.push('/')}
          className="relative hidden h-16 w-24 cursor-pointer lg:inline-grid"
        >
          <Image
        ...
        <div className="flex max-w-xs items-center">
          <div className="relative mt-1 rounded-md p-3 ">
            ...
            <input
              className="block w-full rounded-md border border-gray-300 bg-gray-50 pl-10
          ...
          {session ? (
            <>
              <div className="navBtn relative">
                ...
                <div
                  className="absolute -top-1 -right-2 flex h-5 w-5 animate-pulse items-center justify-center
